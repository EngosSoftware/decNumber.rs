...
mod tests {
  ...
  fn test_dec_quad_from_i16() {
    assert_from!(
      "[A2 08 00 00 00 00 00 00 00 00 00 00 00 00 CB E8]",
      i16::MIN
    );
    assert_from!(
      "[A2 08 00 00 00 00 00 00 00 00 00 00 00 00 40 00]",
      -10_000_i16
    );
    assert_from!(
    ...
    assert_from!(
      "[A2 08 00 00 00 00 00 00 00 00 00 00 00 00 00 80]",
      -100_i16
    );
    ...
    assert_from!(
      "[22 08 00 00 00 00 00 00 00 00 00 00 00 00 40 00]",
      10_000_i16
    );
    assert_from!(
      "[22 08 00 00 00 00 00 00 00 00 00 00 00 00 CB E7]",
      i16::MAX
    );
  }
  ...
  fn test_dec_quad_from_u16() {
    ...
    assert_from!(
      "[22 08 00 00 00 00 00 00 00 00 00 00 00 01 96 B5]",
      u16::MAX
    );
  }
  ...
  fn test_dec_quad_from_i64() {
    ...
    assert_from!(
      "[A2 08 00 00 00 00 00 00 10 00 00 00 00 00 00 00]",
      -1_000_000_000_000_000_000_i64
    );
    assert_from!(
      "[A2 08 00 00 00 00 00 00 00 04 00 00 00 00 00 00]",
      -1_000_000_000_000_000_i64
    );
    assert_from!(
      "[A2 08 00 00 00 00 00 00 00 00 01 00 00 00 00 00]",
      -1_000_000_000_000_i64
    );
    assert_from!(
      "[A2 08 00 00 00 00 00 00 00 00 00 00 40 00 00 00]",
      -1_000_000_000_i64
    );
    assert_from!(
      "[A2 08 00 00 00 00 00 00 00 00 00 00 00 10 00 00]",
    ...
    assert_from!(
      "[22 08 00 00 00 00 00 00 00 00 01 00 00 00 00 00]",
      1_000_000_000_000_i64
    );
    assert_from!(
      "[22 08 00 00 00 00 00 00 00 04 00 00 00 00 00 00]",
      1_000_000_000_000_000_i64
    );
    assert_from!(
      "[22 08 00 00 00 00 00 00 10 00 00 00 00 00 00 00]",
      1_000_000_000_000_000_000_i64
    );
    assert_from!(
  ...
  fn test_i64_from_dec_quad() {
    ...
    assert_eq!(
      Ok(-1_000_000_000_000_000_000_i64),
      i64::try_from(DecQuad::from(-1_000_000_000_000_000_000_i64))
    );
    assert_eq!(
      Ok(-1_000_000_000_000_000_i64),
      i64::try_from(DecQuad::from(-1_000_000_000_000_000_i64))
    );
    assert_eq!(
      Ok(-1_000_000_000_000_i64),
      i64::try_from(DecQuad::from(-1_000_000_000_000_i64))
    );
    assert_eq!(
      Ok(-1_000_000_000_i64),
      i64::try_from(DecQuad::from(-1_000_000_000_i64))
    );
    assert_eq!(
      Ok(-1_000_000_i64),
      i64::try_from(DecQuad::from(-1_000_000_i64))
    );
  ...
  fn test_dec_quad_from_u64() {
    ...
    assert_from!(
      ...
      18_446_744_073_709_550_610_u64
    );
    assert_from!(
  ...
  fn test_u64_from_dec_quad() {
    ...
    assert_eq!(
      Ok(1_000_000_000_000_000_000_u64),
      u64::try_from(DecQuad::from(1_000_000_000_000_000_000_u64))
    );
    assert_eq!(
      Ok(1_844_674_407_370_955_069_u64),
      u64::try_from(DecQuad::from(1_844_674_407_370_955_069_u64))
    );
    assert_eq!(
      Ok(9_223_372_036_854_775_807_u64),
      u64::try_from(DecQuad::from(9_223_372_036_854_775_807_u64))
    );
    assert_eq!(
      Ok(18_446_744_073_709_550_610_u64),
      u64::try_from(DecQuad::from(18_446_744_073_709_550_610_u64))
    );
