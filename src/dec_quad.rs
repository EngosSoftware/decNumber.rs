...
use crate::dec_number_local::DEC_QUAD_ZERO;
...
impl Debug for DecQuad {
  /// Converts [DecQuad] to a string of hexadecimal bytes.
...
///
pub fn dec_quad_to_string(_dec_quad: &DecQuad) -> String {
  "".to_string()
}
...
mod tests {
  ...
  #[test]
  fn test_dec_quad_to_string() {
    let mut dec_quad = DecQuad::default();
    dec_quad_from_i32(&mut dec_quad, -100);
    assert_eq!("", dec_quad_to_string(&mut dec_quad).as_str());
  }
}
